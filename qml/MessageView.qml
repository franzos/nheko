...
Item {
    ...
    ListView {
        ...
        property int delegateMaxWidth: width //((Settings.timelineMaxWidth > 100 && Settings.timelineMaxWidth < chatRoot.availableWidth) ? Settings.timelineMaxWidth : chatRoot.availableWidth) - chatRoot.padding * 2 - (scrollbar.interactive? scrollbar.width : 0)
        ...
        Control {
            ...
            background: Rectangle {
                ...
                border.color: GlobalObject.colors.buttonText
                border.width: 1
                radius: padding
            }
            ...
            contentItem: RowLayout {
                ...
                ImageButton {
                    ...
                    buttonTextColor: GlobalObject.colors.buttonText
                    width: 16
                    hoverEnabled: true
        ...
        delegate: Item {
            ...
            TimelineRow {
                ...
                background: Rectangle {
                    ...
                    z: 1
                    enabled: false
                    color: GlobalObject.colors.highlight
