...
Control {
    ...
    contentItem: ListView {
        ...
        delegate: Rectangle {
            ...
            color: model.index == popup.currentIndex ? GlobalObject.colors.highlight : GlobalObject.colors.base
            ...
            Ripple {
                color: Qt.rgba(GlobalObject.colors.base.r, GlobalObject.colors.base.g, GlobalObject.colors.base.b, 0.5)
            }
                ...
                DelegateChoice {
                    ...
                    RowLayout {
                        ...
                        Label {
                            ...
                            color: model.index == popup.currentIndex ? GlobalObject.colors.highlightedText : GlobalObject.colors.text
                        }

                        Label {
                            text: "(" + model.userid + ")"
                            color: model.index == popup.currentIndex ? GlobalObject.colors.highlightedText : GlobalObject.colors.buttonText
                        }
    ...
    background: Rectangle {
        ...
        border.color: GlobalObject.colors.mid
    }
