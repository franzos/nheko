...
CustomApplicationWindow {
    ...
    minimumWidth: Math.max(rootLayout.implicitWidth+2*rootLayout.anchors.margins, footer.implicitWidth + 20)
    ...
    footer: DialogButtonBox {
        ...
        onAccepted: {
            ...
            GlobalObject.createRoom(space, newRoomName.text, newRoomTopic.text, newRoomAlias.text, isEncrypted.checked, preset)
