...
Rectangle {
    ...
    color: {
        var wc = GlobalObject.colors.alternateBase;
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            ImageButton {
                ...
                image: {
                    if (control.muted || control.desiredVolume <= 0)
                        return ":/images/volume-off-indicator.svg";
                    else
                        return ":/images/volume-up.svg";
                }
            ...
            NhekoSlider {
                ...
                states: State {
                    name: "shown"
                    when: volumeButton.hovered || volumeSlider.hovered || volumeSlider.pressed
